data "aws_availability_zones" "available" {
  # Fetches a list of available availability zones in the current AWS region.
  state = "available"
}
...
resource "aws_security_group" "ecs" {
  ...
  egress { # Explicitly define egress (outbound) rules
    from_port   = 0
    to_port     = 0
    protocol    = "-1"
...
# The NAT Gateway is placed in the first public subnet (aws_subnet.public[0]).
